...
public class DatabaseDataInitializer {
    ...
    public void populateWithDummyData() {
        ...
        accountRepository.save(DoctorEntity.builder().photo("doctor5").name("Emily").fname("Anderson").description("Dr. Emily Anderson is a leading Dermatologist who blends science and art in her practice. She is known for her innovative skincare solutions and her personalized approach to each patient's unique needs. Dr. Anderson's goal is to help her patients achieve not only healthy skin but also a renewed sense of confidence and well-being.").username("doctor").accountType(AccountType.Doctor).availableTimeSlots(timeSlots.stream().map(ReverseTimeSlotConverter::convert).toList()).Email("doctor@gmail.com").password("12345").specialization("Dermatologist").build());
